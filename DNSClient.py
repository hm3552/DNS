...
local_host_ip = '127.0.0.1'  # Localhost for your own DNS server
real_name_server = '8.8.8.8'  # Google Public DNS (you could also use 1.1.1.1 for Cloudflare)
...
# Define a function to compare the results from the local and public DNS servers for each domain name
